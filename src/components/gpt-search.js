...
import { faSquareCheck,faPenToSquare,faMagnifyingGlass,faUser,faBuildingUser,faRectangleList,faListCheck,faChartPie,faCircleCheck,faHouse,faArrowRightFromBracket,faArrowDownLong,faMessage } from '@fortawesome/free-solid-svg-icons';
