...
import { faSquareCheck,faPenToSquare,faRectangleList,faMagnifyingGlass,faUser,faBuildingUser,faListCheck,faChartPie,faCircleCheck,faHouse,faArrowRightFromBracket,faArrowDownLong,faMessage } from '@fortawesome/free-solid-svg-icons';
    ...
    <ul>
        {is_staff && (
            <>
               ...
               <li><a href="http://localhost:3000/manage/" onClick={handleManageClick}>
               <FontAwesomeIcon icon={faListCheck} />Manage {getNewNotificationsCount() > 0 && `(${getNewNotificationsCount()})`}
                ...
                <li>
                <a href="http://localhost:3000/"><FontAwesomeIcon icon={faHouse} />Home</a>
              </li>
            </>
        )}
        {!is_staff && (
