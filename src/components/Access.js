    ...
    <div  className="custom-page custom-page-manage">
        ...
        <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`} >
            ...
            <a className='sidebar-logo' href='http://localhost:3000/search/'><img className='sidebar-logo-image' src={logo} alt="Logo" /></a>
                ...
                <li><a href="http://localhost:3000/massages/"><FontAwesomeIcon icon={faMessage} />Massages</a></li>
                <li><a href="http://localhost:3000/tasks/"><FontAwesomeIcon icon={faSquareCheck} />Tasks</a></li>
